...
// ✅ Import your data (choose ONE structure)

// 👉 Option A (recommended: all categories in one file)
// import newsData from "@/datas/news";

// 👉 Option B (if you have separate export)
...
export default function Page() {
  ...
  // ✅ Option B (if using separate export)
  const categoryNews = BUSINESS_NEWS;
